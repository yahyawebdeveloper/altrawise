...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Bootstrap Tables | UBold - Responsive Admin Dashboard Template</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table data-toggle="table" data-show-columns="false" data-page-list="[5, 10, 20]" data-page-size="5"
                                            data-buttons-class="xs btn-light" data-pagination="true" class="table table-bordered table-hover table-borderless">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table data-toggle="table" data-page-size="5" data-buttons-class="xs btn-light" data-pagination="true"
