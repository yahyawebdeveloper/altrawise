  ...
  var Validator = function (options)
  {
    ...
    */
    this.messages = {
      ...
      , extension: "File mime type not allowed"
      , filesize: "This file should not be larger than %s MB"
      , uppercase: "Only uppercase alphabets allowed"
    },
  ...
  Validator.prototype = {
    ...
    */
    , validators: {
      ...
      , extension: function (file_name, extensions)
      {
      ...
      , filesize: function (_value, maxSize, parsleyInstance)
      {
      ...
      , remote: function (val, url, self)
      {
        ...
        {
          let jsfile = 'parsley_customized.js';
          ...
          let url = myurl.split("public/assets/js/custom_js/");
          let final_url = url[0] + "services/services.php"
          return final_url;
        }
        ...
        $.ajax($.extend({}, {
          ...
          , type: self.options.remoteMethod || 'POST'
          , success: function (response)
          {
            response = handleResponse(response);
            response = !Boolean(Number(response.code));
            //check whether the edit value is same as current value
            if ($.trim(self.$element.attr('data-edit-value')) == $.trim(val))
            {
              var response = '{"code":"0","msg":"Success","data":"0"}';
              manage(true, manageErrorMessage(response));
            }
            else
            {
    ...
    */
    , addError: function (error)
    {
      for (var constraint in error)
      {
        ...
        // $('#detail_form').append($( liTemplate ).html('sdf'));
