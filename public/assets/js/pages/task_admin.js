!(function (t) {
    ...
    (e.prototype.initSelect2 = function () {
        ...
        (e.prototype.initSelectize = function () {
            t("#selectize-tags").selectize({ persist: !1, createOnBlur: !0, create: !0 }),
                t("#selectize-select").selectize({ create: !0, sortField: { field: "text", direction: "asc" }, dropdownParent: "body" }),
