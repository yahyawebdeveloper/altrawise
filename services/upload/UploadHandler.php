...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null)
    {
        ...
        (
            ...
            'max_file_size' 					=> null, //1024102
            'min_file_size' 					=> 1, //null,
    ...
    protected function set_additional_file_properties($file)
    {
        ...
        // if($this->options['item_data'])
        // {
        //     $file->deleteUrl .=  $this->options['item_data'];
        // }
    ...
    protected function validate($uploaded_file, $file, $error, $index)
    {
        ...
        //restrict uploading executable files to server
        $blacklist_extensions = array(".php", ".phtml", ".php3", ".php4", ".js", ".shtml", ".pl" ,".py");
        foreach ($blacklist_extensions as $blacklist_extension)
        {
            if(preg_match("/$blacklist_extension\$/i", $file->name))
            {
                $file->error ="ERROR: Uploading executable files Not Allowed\n";
                return false;
            }
        }
    ...
    protected function get_file_name($name,
            $type = null, $index = null, $content_range = null)
    {
        if (isset($this->options['overwrite_status']))
        {
    ...
    protected function handle_form_data($file, $index)
    {
        if (isset($_REQUEST['recordId'])) {
            ...
            $file->name = $_REQUEST['recordId'] . '.' . $pathinfo['extension'];
        }
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,$index = null, $content_range = null)
    {
        sleep(5);
        /**
     	 * Custom code to enable file renaming after upload thru new option called 'filename'
     	 * @author:   Darus
    	 */
    	$new_name = '';
        ...
        if(isset($this->options['item_data']))
        {
        	$file->item_data =  $this->options['item_data'];
        }
